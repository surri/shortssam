    ...
    scenes: [
      {
        ...
        onscreen: "$x^2-5x+6=0$",
        caption: "이차방정식 $x^2-5x+6=0$, 인수분해 각!",
        accentWords: ["인수분해"],
        seconds: 5,
      },
      {
